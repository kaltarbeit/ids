...
export const createTextField = () => {
    ...
    const amountField = wrapper.querySelector('.ids-text-field-amount');
    const amountFieldInput = wrapper.querySelector('.ids-text-field-amount input');
    const clearButton = wrapper.querySelector('.ids-text-field-amount .ids-input-clear');
    ...
    amountFieldInput.addEventListener('input', (e) => {
        ...
        count > 0 ? amountField.classList.add('ids-text-field-filled') : amountField.classList.remove('ids-text-field-filled');
    ...
    clearButton.addEventListener('click', () => {
        ...
        amountField.classList.remove('ids-text-field-filled');
