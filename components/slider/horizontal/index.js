...
// 슬라이더 값 범위 설정
    ...
    const trackRange = wrapper.querySelector('#sliderTrackRange');
    ...
    function updateSliderPosition(value) {
        ...
        // 슬라이더 컨테이너 높이
        const sliderHeight = slider.clientHeight- handle.offsetHeight;
    ...
    handle.addEventListener('mouseenter', onMouseHover);
